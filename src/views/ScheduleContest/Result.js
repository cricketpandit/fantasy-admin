...
const Result = (props) => {
  ...
  const handleSearching = async () => {
    ...
    path = apiUrl.get_series_completed_matches + '?page=' + `${page}` + '&itemsPerPage=' + `${itemsPerPage}` + '&keyword=' + `${keywords}` + '&contestType=' + `${contestType}` + '&quizCat=' + `${category_id}` + '&start_date=' + `${startdate == '' ? '' : moment(startdate).format('YYYY-MM-DD')}` + '&end_date=' + `${enddate == '' ? '' : moment(enddate).format('YYYY-MM-DD')}` + '&status=' + `${serachstatus}`;
    getData(path)
  };
                              ...
                              <tr>
                                ...
                                <td>
                                  <button
                                    className={'btn circle_btn table_auto_btn mr-5 '}
                                    type={'button'}
                                    onClick={(e) => { set_rank(item.match_id, item.series_id) }}
                                  >
                                    Set Rank
                                  </button>
                                </td>
                                <td>
                                  ...
                                  <button
                                    className={'btn circle_btn table_auto_btn mr-5 '}
                                    type={'button'}
                                    onClick={(e) => { set_winning_amount(item.match_id, item.series_id) }}
                                  >
                                    Set Winning Amount
                                  </button>
                                ...
                                <td>
                                  ...
                                  <button
                                    className={'btn circle_btn table_auto_btn mr-5 '}
                                    type={'button'}
                                    onClick={(e) => { prize_distribution(item.match_id, item.series_id) }}
                                  >
                                    Prize Distribution
                                  </button>
