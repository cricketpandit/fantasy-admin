...
const T20Other = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let path = apiUrl.update_t20_other;
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersCaptain" placeholder="Captain" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.othersCaptain} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersViceCaptain" placeholder="Vice-Captain" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.othersViceCaptain} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersStarting11" placeholder="In starting 11" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.othersStarting11} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                        </Row>
                    </CardBody>
