...
const T20Feilding = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let postJson = {
            ...
            t20IndirectRunOut: data.t20IndirectRunOut.trim()

        };

        let path = apiUrl.update_t20_feilding;
    ...
    const getData = async () => {
        let path = apiUrl.get_t20_feilding;
                        ...
                        <Row>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" max={11} onChange={handleCatch} min={0} step="0.1" name="fieldingCatch" placeholder="Catch" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.fieldingCatch} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="fieldingStumpRunOut" placeholder="Stumping/Run-out" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.fieldingStumpRunOut} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="fieldingRunOutThrower" placeholder="Run-out" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.fieldingRunOutThrower} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="t20IndirectRunOut" placeholder="Run-out ( Not Direct hit )" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t20Data.t20IndirectRunOut} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                        </Row>
                    </CardBody>
