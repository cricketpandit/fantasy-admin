                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingRun" placeholder="Run" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t10Data.battingRun} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingBoundary" placeholder="Boundary Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t10Data.battingBoundary} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingSix" placeholder="Six Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t10Data.battingSix} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    <Label className={'col-md-4 pull-left mt-2'}>30 Runs Bonus:</Label>
                                    <input type="number" min={0} step="0.1" name="t10Bonus30Runs" placeholder="30 Runs Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t10Data.t10Bonus30Runs} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    <Label className={'col-md-4 pull-left mt-2'}>50 Runs Bonus:</Label>
                                    <input type="number" min={0} step="0.1" name="t10Bonus50Runs" placeholder="50 Runs Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={t10Data.t10Bonus50Runs} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
