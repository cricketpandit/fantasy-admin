...
const TestBowling = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let path = apiUrl.update_test_bowling;
    ...
    const getData = async () => {
        let path = apiUrl.get_test_bowling;
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="bowlingWicket" placeholder="Wicket" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={testData.bowlingWicket} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="bowling4Wicket" placeholder="4 wicket haul Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={testData.bowling4Wicket} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="bowling5Wicket" placeholder="5 wicket haul Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={testData.bowling5Wicket} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                        </Row>
                    </CardBody>
