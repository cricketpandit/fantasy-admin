...
const TestOther = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let path = apiUrl.update_test_other;
    ...
    const getData = async () => {
        let path = apiUrl.get_test_other;
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersCaptain" placeholder="Captain" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={testData.othersCaptain} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersViceCaptain" placeholder="Vice-Captain" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={testData.othersViceCaptain} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersStarting11" placeholder="In starting 11" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={testData.othersStarting11} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                        </Row>
                    </CardBody>
