...
const OdiOther = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let path = apiUrl.update_odi_other;
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersCaptain" placeholder="Captain" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.othersCaptain} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersViceCaptain" placeholder="Vice-Captain" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.othersViceCaptain} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="othersStarting11" placeholder="In starting 11" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.othersStarting11} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                        </Row>
                    </CardBody>
