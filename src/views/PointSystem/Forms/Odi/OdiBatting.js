...
const OdiBatting = (props) => {
    ...
    const onSubmit = async data => {
        ...
        let path = apiUrl.update_odi_batting;
    ...
    const getData = async () => {
        let path = apiUrl.get_odi_batting;
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingRun" placeholder="Run" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.battingRun} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingBoundary" placeholder="Boundary Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.battingBoundary} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingSix" placeholder="Six Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.battingSix} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingHalfCentury" placeholder="Half-century Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.battingHalfCentury} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" min={0} step="0.1" name="battingCentury" placeholder="Century Bonus" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.battingCentury} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <input type="number" step="0.1" name="battingDuck" placeholder="Dismissal for a duck" autoComplete="off"
                                        className="form-control col-md-8" defaultValue={odiData.battingDuck} ref={register({ required: 'Required' })} />
                                </FormGroup>
                            </Col>
                        </Row>
                    </CardBody>
