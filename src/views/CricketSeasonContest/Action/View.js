...
const View = (props) => {
  ...
  return (
    <div className={"inline-btn"}>
      <button className="btn circle_btn btn-sm mr-1 mt-1" type="button" title="Status" onClick={(e) => { setModal(true);}}><i className="fa fa-eye" /></button>
          ...
          <Row>            
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <div>{_.upperFirst(item?.name)}</div>
              </FormGroup>
            </Col>
            <Col md={6}>
              <FormGroup>
