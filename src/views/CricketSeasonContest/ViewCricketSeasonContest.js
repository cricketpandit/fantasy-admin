...
const ViewCricketSeasonContest = (props) => {
  ...
  return (
      ...
      <button className="btn circle_btn btn-sm mr-1 mt-1" type="button" title="View Details" onClick={(e) => { setModal(true);}}><i className="fa fa-eye"></i></button>
...
export default ViewCricketSeasonContest;